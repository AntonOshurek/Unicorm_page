...
var footerMapLink = function footerMapLink() {
  //if browser on javaScript

  var noJsMap = document.querySelector('.footer__no-js-map');
  var imageItems = document.querySelectorAll('.services__img-wrap');
  noJsMap.remove();
...
var mobileMenu = function mobileMenu() {
  ...
  var navButtonndicator = document.querySelector('.nav-button__indicator');
  var navBlock = document.querySelector('.nav');
  var navButtonSvg = document.querySelector('.ham');
  var body = document.querySelector('.body');
  var menuBackground = document.querySelector('.header__menu-bg');
  ...
  var onMenuBGCloseMenu = function onMenuBGCloseMenu() {
    closeMenu();
  };
  ...
  var onMobileMenuToogle = function onMobileMenuToogle(evt) {
...
var navScroll = function navScroll() {
  ...
  var onScrollCheck = function onScrollCheck() {
  ...
  var onHeightCheck = function onHeightCheck() {
...
var setCurrentMenuItem = function setCurrentMenuItem() {
  ...
  var secArr = [].concat(_toConsumableArray(allSections), [footerBlock]);
  var markCurrentMenuItem = function markCurrentMenuItem() {
    secArr.forEach(function (section) {
      var sectionClass;
...
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var showServices = function showServices() {
  var imageItems = _toConsumableArray(document.querySelectorAll('.services__img-wrap'));
  var options = {
    rootMargin: '0px',
    threshold: .2
  };
  var setItemActive = function setItemActive(entries) {
...
/*!*********************************!*\
  ...
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _blocks_nav_scroll_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blocks/nav-scroll.js */ "./source/scripts/blocks/nav-scroll.js");
/* harmony import */ var _blocks_set_current_menu_item_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./blocks/set-current-menu-item.js */ "./source/scripts/blocks/set-current-menu-item.js");
/* harmony import */ var _blocks_mobile_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./blocks/mobile-menu.js */ "./source/scripts/blocks/mobile-menu.js");
/* harmony import */ var _blocks_show_services_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./blocks/show-services.js */ "./source/scripts/blocks/show-services.js");
/* harmony import */ var _blocks_footer_map_link_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./blocks/footer-map-link.js */ "./source/scripts/blocks/footer-map-link.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // navScroll();
  (0,_blocks_set_current_menu_item_js__WEBPACK_IMPORTED_MODULE_1__.setCurrentMenuItem)();
  (0,_blocks_mobile_menu_js__WEBPACK_IMPORTED_MODULE_2__.mobileMenu)();
  (0,_blocks_show_services_js__WEBPACK_IMPORTED_MODULE_3__.showServices)();
  (0,_blocks_footer_map_link_js__WEBPACK_IMPORTED_MODULE_4__.footerMapLink)();
});
}();
/******/ })()
;
